...
return (
  <group {...props} dispose={null}>
    <group name="Room092" position={[-172.066, 32.191, -212.124]}>
      <mesh
        name="Room092_1"
        geometry={nodes.Room092_1.geometry}
        material={materials['Material.094']}
      />
      <mesh
        name="Room092_2"
        geometry={nodes.Room092_2.geometry}
        material={materials['Material.095']}
      />
      <mesh
        name="Room092_3"
        geometry={nodes.Room092_3.geometry}
        material={materials['Material.096']}
      />
      <mesh
        name="Room092_4"
        geometry={nodes.Room092_4.geometry}
        material={materials['Material.097']}
      />
      <mesh
        name="Room092_5"
        geometry={nodes.Room092_5.geometry}
        material={materials['Material.066']}
      />
      <mesh
        name="Room092_6"
        geometry={nodes.Room092_6.geometry}
        material={materials['Material.067']}
      />
      <mesh
        name="Room092_7"
        geometry={nodes.Room092_7.geometry}
        material={materials['Material.033']}
      />
      <mesh
        name="Room092_8"
        geometry={nodes.Room092_8.geometry}
