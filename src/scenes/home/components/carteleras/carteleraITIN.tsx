...
export function CarteleraITIN(props: JSX.IntrinsicElements['group']) {
    ...
    const texture = useLoader(THREE.TextureLoader, `${import.meta.env.BASE_URL}img/carteleras/itin.png`);
    ...
    return (
        <>
            <group {...props} dispose={null}>
                <group position={[71.849, 5.603, -19.5]} onClick={showModal}>
            ...
            <Html>
                <Modal
                    title="TÍTULO A OBTENER: INGENIERO/A EN TECNOLOGÍAS DE LA INFORMACIÓN"
                ...
                >
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                        <div style={{ paddingRight: '3%', display: 'flex', flexDirection: 'column', width: '40%' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'row', gap: '5%' }}>
                                <a
                                    href='https://santodomingo.espe.edu.ec/ingenieria-en-tecnologias-de-la-informacion/'
                                ...
                                <a
                                    href='https://www.facebook.com/ITINSD'
                                    target='_blank' rel='noreferrer'
                                    style={{
                                        background: 'rgb(0, 112, 60)',
                                        color: 'white',
                            ...
                            <div>
                                ...
                                <span>
                                    El Ingeniero en Tecnologías de la Información (TI), responde a una necesidad nacional
                                    como un profesional competente para aportar directamente en la materialización del cambio
                                    de modelo de producción del país, y en el soporte transversal
                                    que pueda brindar a las políticas expresadas en el Plan Nacional de Desarrollo.
                                </span>
                                <br />
                                <br />
                                <strong>Malla curricular</strong> <br />
                                <a
                                    href='https://santodomingo.espe.edu.ec/wp-content/uploads/2024/05/0-MALLA-ITIN-ajustada-actualizada-12jul2022.pdf'
                                    target='_blank' rel='noreferrer'
                                    style={{
                                        background: 'rgb(0, 112, 60)',
                                        color: 'white',
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', width: '60%' }}>
                            <img
                                style={{ width: '50%', height: '100%', margin: 'auto', objectFit: 'cover' }}
                                src={`${import.meta.env.BASE_URL}img/carreras/itin1.jpg`}
                                alt="Biotecnologia"
                            />
                            <img
                                style={{ width: '50%', height: '100%', margin: 'auto', objectFit: 'cover' }}
                                src={`${import.meta.env.BASE_URL}img/carreras/itin2.jpg`}
                                alt="Biotecnologia"
                            />
