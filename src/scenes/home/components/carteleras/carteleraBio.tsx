...
export function CarteleraBIO(props: JSX.IntrinsicElements['group']) {
    ...
    const texture = useLoader(THREE.TextureLoader, `${import.meta.env.BASE_URL}img/carteleras/biotecnologia.png`);
    ...
    return (
        <>
            <group {...props} dispose={null}>
                <group position={[71.849, 5.603, -11.5]} onClick={showModal}>
            ...
            <Html>
                <Modal
                    title="TÍTULO A OBTENER: INGENIERO/A BIOTECNÓLOGO/A"
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                        <div style={{ paddingRight: '3%', display: 'flex', flexDirection: 'column', width: '60%' }}>
                            ...
                            <div>
                                ...
                                <span>
                                    El Ingeniero Biotecnólogo es un profesional que diseña y
                                    aplica sistemas biotecnológicos, dirigidos a la solución
                                    de problemas de salud, ambiente, biodiversidad e industria,
                                    a nivel de investigación y producción, con conciencia
                                    social y respeto a los derechos humanos y ambientales.
                                </span>
                                <br />
                                <br />
                                <strong>Malla curricular</strong> <br />
                                <a
                                    href='https://www.espe.edu.ec/wp-content/uploads/2023/08/MALLA_REAJUSTE_CODIFICADA_19102020_BIOTECNOLOGIA_MATRIZ_RV.pdf'
                                    target='_blank'
                                    rel='noreferrer'
                                    style={{
                                        background: 'rgb(0, 112, 60)',
