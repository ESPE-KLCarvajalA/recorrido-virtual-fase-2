...
export function ParedLabCiencias2(props: ThreeElements['group']) {
  const { nodes, materials } = useGLTF('models/labCiencias2/paredLabCiencias2.glb') as unknown as GLTFResult
...
useGLTF.preload('models/labCiencias2/paredLabCiencias2.glb')
