...
export function Ventanas2() {
  ...
  const instances: InstanceData[] = [
    ...
    { name: 'Ventana_012', position: [-721.288, 35, -482.914], rotation: [0,0,0], scale: [1, 1, 0.8] },
    { name: 'Ventana_013', position: [-844.582, 36, -409.664], rotation: [0,0,0], scale: [1, 1.1, 1] },
    { name: 'Ventana_014', position: [-824.801, 26, 159.244], rotation: [0,0,0], scale: [1, 1.1, 1] },
    { name: 'Ventana_014', position: [-824, 26, 223.6], rotation: [0,0,0], scale: [1, 1.1, 1] },
    ...
    { name: 'Ventana_018', position: [-785.539, 29, 126.415], rotation: [0,1.57,0], scale: [1, 0.9, 0.5] },
    { name: 'Ventana_019', position: [-854.965, 45, -183.902], rotation: [0,0,0], scale: [1, 1, 1] },
    { name: 'Ventana_020', position: [-789.623, 42, -117.321], rotation: [0,0,0], scale: [1, 1, 1] },
    ...
    { name: 'Ventana_028-', position: [-495, 39, -365], rotation: [-Math.PI, -0.9, -Math.PI], scale: [1, 0.5, 0.3] },
    { name: 'Ventana_029-', position: [-481.194, 39, -361], rotation: [-Math.PI, 1.57, -Math.PI], scale: [1,0.5,0.4] },
    { name: 'Ventana_034-', position: [-456.901, 39, -360.674], rotation: [-Math.PI, 1.57, -Math.PI], scale: [1,0.5,0.365] },
    { name: 'Ventana_035-', position: [-443.518, 39, -366.5], rotation: [-Math.PI, 0.8, -Math.PI], scale: [1, 0.5, 0.38] },

    { name: 'Ventana_030/', position: [-490.128, 39, -646.427], rotation: [-Math.PI, -0.9, -Math.PI], scale: [1, 0.6, 0.35] },
    { name: 'Ventana_031/', position: [-476.878, 39, -641.029], rotation: [-Math.PI, 1.57, -Math.PI], scale: [1,0.6,0.35] },
    { name: 'Ventana_036/', position: [-454.714, 40, -641.002], rotation: [-Math.PI, 1.57, -Math.PI], scale: [1,0.6,0.365] },
    { name: 'Ventana_037 /', position: [-441.331, 40, -645.885], rotation: [-Math.PI, 0.8, -Math.PI], scale: [1, 0.6, 0.38] },

    

    { name: 'Ventana_032', position: [-470.509, 42.975, -803.756], rotation: [0, 1.57, 0], scale: [1, 0.5, 0.5] },
    { name: 'Ventana_033 ', position: [-472.194, 43, -523.783], rotation: [0, 1.57, 0], scale: [1, 0.5, 0.5] },
    
    
    { name: 'Ventana_038', position: [-843.734, 39.847, -473.953], rotation: [0,0,0], scale: [1, 0.65, 0.55] },
    { name: 'Ventana_039', position: [-713.943, 41, -559.961], rotation: [0,0,0], scale: [1, 0.45, 0.55] },
    
    { name: 'Ventana_040', position: [-219.983, 44, -825.995], rotation: [0,0,0], scale: [1, 0.3, 0.55] },
    { name: 'Ventana_041', position: [-104.46, 40.5, -753.116], rotation: [0,0,0], scale: [1, 0.6, 0.55] },
    ...
    { name: 'Ventana_046', position: [-844.582, 35.5, -540.4], rotation: [0,0,0], scale: [1, 1.1, 1] },
    { name: 'Ventana_047', position: [-368.974, 36.5, -691.607], rotation: [0,0,0], scale: [1, 1.1, 1] },
    { name: 'Ventana_048', position: [-230.304, 34, -671], rotation: [0,0,0], scale: [1, 1.1, 0.95] },
    { name: 'Ventana_049', position: [-211.403, 32, -743.754], rotation: [0,0,0], scale: [1, 0.9, 0.8] },
    { name: 'Ventana_050', position: [-104.53, 34.5, -683.326], rotation: [0,0,0], scale: [1, 1.1, 1] },
    { name: 'Ventana_051', position: [-104.53, 34.5, -822.501], rotation: [0,0,0], scale: [1, 1.1, 1] },
    { name: 'Ventana_052', position: [-368.974, 36.5, -764.226], rotation: [0,0,0], scale: [1, 1.1, 1] },
    ...
    { name: 'Ventana_055', position: [-405.538, 35.48, -931.418], rotation: [0, 1.57, 0], scale: [1, 1.2, 1] },
    { name: 'Ventana_056', position: [-520.084, 36.335, -931.418], rotation: [0, 1.57, 0], scale: [1, 1.1, 1] },
    { name: 'Ventana_057', position: [-372.04, 36.5, -475], rotation: [0,0,0], scale: [1, 1.1, 1.1] },
    { name: 'Ventana_058', position: [-809.429, 38, -922.603], rotation: [0,1.57,0], scale: [1, 1, 1] },
    { name: 'Ventana_059', position: [-743.933, 38, -922.603], rotation: [0,1.57,0], scale: [1, 1, 1] },
    { name: 'Ventana_060', position: [-713.37, 37, -888.392], rotation: [0,0,0], scale: [1, 1, 1] },
    { name: 'Ventana_061', position: [-713.37, 38.5, -773.904], rotation: [0,0,0], scale: [1, 1.1, 1] },
