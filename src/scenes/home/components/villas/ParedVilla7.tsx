...
export function ParedVilla7(props: ThreeElements['group']) {
  const { nodes, materials } = useGLTF('/paredVilla7.glb') as unknown as GLTFResult
  return (
    <group {...props} dispose={null}>
      ...
      <group name="piso_arco002" position={[-671.147, -6.982, 188.96]} scale={[4.683, 1, 1]}>
        <mesh
          name="Plane088"
...
useGLTF.preload('/paredVilla7.glb')