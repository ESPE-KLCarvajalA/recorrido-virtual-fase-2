...
export function SillaBar() {
  ...
  const instances: InstanceData[] = [
    ...
    { position: [-409.935, 3, -275], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
    { position: [-448.575, 3, -275], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
    {  position: [-488.381, 3, -275], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
    { position: [-527.662, 3, -275], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
