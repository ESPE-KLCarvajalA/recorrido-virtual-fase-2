...
export function SillaBar() {
  ...
  { position: [-409.935, -1.797, -209.586], rotation: [0, 0, 0], scale: [1, 1, 1] },
  { position: [-409.935, -1.797, -262.61], rotation: [0, 0, 0], scale: [1, 1, 1] },
  { position: [-448.575, -1.797, -262.61], rotation: [0, 0, 0], scale: [1, 1, 1] },
  {  position: [-488.381, -1.797, -262.61], rotation: [0, 0, 0], scale: [1, 1, 1] },
  { position: [-448.402, -1.797, -209.586], rotation: [0, 0, 0], scale: [1, 1, 1] },
  { position: [-488.142, -1.797, -209.586], rotation: [0, 0, 0], scale: [1, 1, 1] },
  { position: [-527.578, -1.797, -209.586], rotation: [0, 0, 0], scale: [1, 1, 1] },
  { position: [-527.662, -1.797, -262.61], rotation: [0, 0, 0], scale: [1, 1, 1] },
