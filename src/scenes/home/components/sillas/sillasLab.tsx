...
export function SillasLab() {
  ...
  const instances: InstanceData[] = [
    { position: [19.402, 10, -335.884], rotation: [0, 0, 0], scale: [1, 1, 1] },
    { position: [157.668, 10, -299.409], rotation: [0, 2/Math.PI , 0], scale: [1, 1, 1] },
    { position: [-21.618, 10, -167.891], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
    { position: [-21.618, 10, -203.551], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
    { position: [71.222, 10, -137.708], rotation: [0, 2/Math.PI, 0], scale: [1, 1, 1] },
    { position: [35.563, 10, -137.708], rotation: [0, 2/Math.PI, 0], scale: [1, 1, 1] },
