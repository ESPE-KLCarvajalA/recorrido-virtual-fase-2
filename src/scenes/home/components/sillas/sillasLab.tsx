...
export function SillasLab() {
  ...
  const instances: InstanceData[] = [
    ...
    { position: [160, 3, -299.409], rotation: [0, -Math.PI / 2, 0], scale: [1, 1, 1] },
    
    { position: [-19, 3, -167.891], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
    { position: [-19, 3, -203.551], rotation: [0, Math.PI / 2, 0], scale: [1, 1, 1] },
    
    { position: [71, 3, -145], rotation: [0, Math.PI, 0], scale: [1, 1, 1] },
    { position: [35, 3, -145], rotation: [0, Math.PI, 0], scale: [1, 1, 1] },
